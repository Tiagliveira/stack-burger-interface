...
import { useNavigate } from 'react-router-dom'; // Importante para não recarregar a página
...
const STATUS_CONTENT_MAP = {
    succeeded: {
        ...
        iconColor: '#30B130',
        icon: SuccessIcon,
        buttonText: 'Acompanhar Meus Pedidos',
        url: '/orders',
    },
    processing: {
    ...
    return (
        <div className='container'>
            <div id="payment-status">
                ...
                <button
                    id="retry-button"
                    onClick={() => navigate(STATUS_CONTENT_MAP[status].url)}
